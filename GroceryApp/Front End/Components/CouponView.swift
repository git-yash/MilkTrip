...
#Preview {
    CouponView(coupon: Coupon(id: 1, store: Store(id: 1, image: Image("walmartLogo"), name: "Walmart", products: []), description: "15% off of all eligible items if you use the code BUY24.", url: "https://www.walmart.com/"))
}
